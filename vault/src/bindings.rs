...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_vault_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_vault_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:vault:vault:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6330] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbe0\x01A\x02\x01A\x13\
...
e\x01\x8d\x01\x03\0\x15wasi:http/types@0.2.6\x05\x09\x02\x03\0\x04\x10incoming-r\
...
ndle\x01\x06\x04\0\x20wasi:http/incoming-handler@0.2.6\x05\x0c\x04\0\x0fnan:vaul\
t/vault\x04\0\x0b\x0b\x01\0\x05vault\x03\0\0\0G\x09producers\x01\x0cprocessed-by\
