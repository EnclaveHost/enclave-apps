      ...
      impl Fields {
        ...
        pub fn from_list(entries: &[(FieldName,FieldValue,)],) -> Result<Fields,HeaderError>{
          unsafe {
            ...
            let vec3 = entries;
            let len3 = vec3.len();
            let layout3 = _rt::alloc::Layout::from_size_align_unchecked(vec3.len() * (4*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
      ...
      impl Fields {
        ...
        pub fn has(&self,name: &str,) -> bool{
          unsafe {
            ...
            let ret = unsafe { wit_import1((self).handle() as i32, ptr0.cast_mut(), len0) };
      ...
      impl Fields {
        ...
        pub fn set(&self,name: &str,value: &[FieldValue],) -> Result<(),HeaderError>{
          unsafe {
            ...
            let vec2 = value;
            let len2 = vec2.len();
            let layout2 = _rt::alloc::Layout::from_size_align_unchecked(vec2.len() * (2*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
            ...
            unsafe { wit_import4((self).handle() as i32, ptr0.cast_mut(), len0, result2, len2, ptr3) };
      ...
      impl Fields {
        ...
        pub fn append(&self,name: &str,value: &[u8],) -> Result<(),HeaderError>{
          unsafe {
            ...
            unsafe { wit_import3((self).handle() as i32, ptr0.cast_mut(), len0, ptr1.cast_mut(), len1, ptr2) };
      ...
      impl OutgoingRequest {
        ...
        pub fn new(headers: Headers,) -> Self{
          unsafe {
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import0(_: i32, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import0((&headers).take_handle() as i32) };
      ...
      impl OutgoingRequest {
        ...
        pub fn set_method(&self,method: &Method,) -> Result<(),()>{
          unsafe {
            ...
            let ret = unsafe { wit_import2((self).handle() as i32, result1_0, result1_1, result1_2) };
            match ret {
              0 => {
                let e = ();
                Ok(e)
      ...
      impl OutgoingRequest {
        ...
        pub fn set_scheme(&self,scheme: Option<&Scheme>,) -> Result<(),()>{
          unsafe {
            ...
            let ret = unsafe { wit_import3((self).handle() as i32, result2_0, result2_1, result2_2, result2_3) };
            match ret {
              0 => {
                let e = ();
                Ok(e)
      ...
      impl RequestOptions {
        ...
        pub fn set_connect_timeout(&self,duration: Option<Duration>,) -> Result<(),()>{
          unsafe {
            ...
            let ret = unsafe { wit_import1((self).handle() as i32, result0_0, result0_1) };
            match ret {
              0 => {
                let e = ();
                Ok(e)
      ...
      impl ResponseOutparam {
        ...
        pub fn set(param: ResponseOutparam,response: Result<OutgoingResponse,ErrorCode>,) -> (){
          unsafe {
            ...
            unsafe { wit_import39((&param).take_handle() as i32, result38_0, result38_1, result38_2, result38_3, result38_4, result38_5, result38_6, result38_7) };
          }
        }
      }
      impl IncomingResponse {
            ...
            let result4 = match l2 {
              0 => {
                let e = {
                  ...
                  unsafe { super::super::super::wasi::io::streams::InputStream::from_handle(l3 as u32) }
                };
                Ok(e)
              }
              1 => {
      ...
      impl OutgoingResponse {
        ...
        pub fn set_status_code(&self,status_code: StatusCode,) -> Result<(),()>{
          unsafe {
            ...
            let ret = unsafe { wit_import0((self).handle() as i32, _rt::as_i32(status_code)) };
            match ret {
              0 => {
                let e = ();
                Ok(e)
            ...
            let result4 = match l2 {
              0 => {
                let e = {
                  ...
                  unsafe { super::super::super::wasi::io::streams::OutputStream::from_handle(l3 as u32) }
                };
                Ok(e)
              }
              1 => {
      ...
      impl OutgoingBody {
        ...
        pub fn finish(this: OutgoingBody,trailers: Option<Trailers>,) -> Result<(),ErrorCode>{
          unsafe {
            ...
            unsafe { wit_import2((&this).take_handle() as i32, result0_0, result0_1, ptr1) };
            let l3 = i32::from(*ptr1.add(0).cast::<u8>());
      ...
      impl InputStream {
        ...
        pub fn read(&self,len: u64,) -> Result<_rt::Vec::<u8>,StreamError>{
          unsafe {
            ...
            unsafe { wit_import1((self).handle() as i32, _rt::as_i64(&len), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
                  ...
                  let v8 = match l6 {
                    0 => {
                      let e8 = {
                        ...
                        unsafe { super::super::super::wasi::io::error::Error::from_handle(l7 as u32) }
                      };
                  ...
                  let v6 = match l4 {
                    0 => {
                      let e6 = {
                        ...
                        unsafe { super::super::super::wasi::io::error::Error::from_handle(l5 as u32) }
                      };
                  ...
                  let v5 = match l3 {
                    0 => {
                      let e5 = {
                        ...
                        unsafe { super::super::super::wasi::io::error::Error::from_handle(l4 as u32) }
                      };
      ...
      impl OutputStream {
        ...
        pub fn splice(&self,src: &InputStream,len: u64,) -> Result<u64,StreamError>{
          unsafe {
            ...
            unsafe { wit_import1((self).handle() as i32, (src).handle() as i32, _rt::as_i64(&len), ptr0) };
            let l2 = i32::from(*ptr0.add(0).cast::<u8>());
            let result7 = match l2 {
              0 => {
                let e = {
    ...
    pub mod tensor {
      ...
      unsafe impl _rt::WasmResource for Tensor{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "wasi:nn/tensor@0.2.0-rc-2024-10-28")]
            unsafe extern "C" {
        ...
        pub fn new(dimensions: &[u32],ty: TensorType,data: &[u8],) -> Self{
          unsafe {
            ...
            unsafe extern "C" {
              ...
              fn wit_import2(_: *mut u8, _: usize, _: i32, _: *mut u8, _: usize, ) -> i32;
            }

            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import2(_: *mut u8, _: usize, _: i32, _: *mut u8, _: usize, ) -> i32{ unreachable!() }
            let ret = unsafe { wit_import2(ptr0.cast_mut(), len0, ty.clone() as i32, ptr1.cast_mut(), len1) };
    ...
    pub mod errors {
      ...
      unsafe impl _rt::WasmResource for Error{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "wasi:nn/errors@0.2.0-rc-2024-10-28")]
            unsafe extern "C" {
              #[link_name = "[resource-drop]error"]
              fn drop(_: u32);
            }
    ...
    pub mod inference {
      ...
      unsafe impl _rt::WasmResource for GraphExecutionContext{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "wasi:nn/inference@0.2.0-rc-2024-10-28")]
            unsafe extern "C" {
      ...
      impl GraphExecutionContext {
        ...
        pub fn compute(&self,inputs: _rt::Vec::<NamedTensor>,) -> Result<_rt::Vec::<NamedTensor>,Error>{
          unsafe {
            ...
            let vec2 = &inputs;
            let len2 = vec2.len();
            let layout2 = _rt::alloc::Layout::from_size_align_unchecked(vec2.len() * (3*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
            let result2 = if layout2.size() != 0 {
              let ptr = _rt::alloc::alloc(layout2).cast::<u8>();
              if ptr.is_null()
              {
            ...
            for (i, e) in vec2.into_iter().enumerate() {
              let base = result2.add(i * (3*::core::mem::size_of::<*const u8>()));
              {
                let (t0_0, t0_1, ) = e;
                let vec1 = t0_0;
                let ptr1 = vec1.as_ptr().cast::<u8>();
                ...
                *base.add(::core::mem::size_of::<*const u8>()).cast::<usize>() = len1;
                *base.add(0).cast::<*mut u8>() = ptr1.cast_mut();
                *base.add(2*::core::mem::size_of::<*const u8>()).cast::<i32>() = (t0_1).take_handle() as i32;
              }
            }
            let ptr3 = ret_area.0.as_mut_ptr().cast::<u8>();
            #[cfg(target_arch = "wasm32")]
            ...
            #[cfg(not(target_arch = "wasm32"))]
            unsafe extern "C" fn wit_import4(_: i32, _: *mut u8, _: usize, _: *mut u8, ){ unreachable!() }
            unsafe { wit_import4((self).handle() as i32, result2, len2, ptr3) };
            let l5 = i32::from(*ptr3.add(0).cast::<u8>());
            let result14 = match l5 {
              0 => {
                let e = {
                  ...
                  for i in 0..len12 {
                    let base = base12.add(i * (3*::core::mem::size_of::<*const u8>()));
                    let e12 = {
                      let l8 = *base.add(0).cast::<*mut u8>();
                      let l9 = *base.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
                      let len10 = l9;
                      let bytes10 = _rt::Vec::from_raw_parts(l8.cast(), len10, len10);
                      let l11 = *base.add(2*::core::mem::size_of::<*const u8>()).cast::<i32>();

                      (_rt::string_lift(bytes10), unsafe { super::super::super::wasi::nn::tensor::Tensor::from_handle(l11 as u32) })
                    };
                    result12.push(e12);
                  }
                  _rt::cabi_dealloc(base12, len12 * (3*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
              ...
              1 => {
                let e = {
                  let l13 = *ptr3.add(::core::mem::size_of::<*const u8>()).cast::<i32>();

                  unsafe { super::super::super::wasi::nn::errors::Error::from_handle(l13 as u32) }
                };
                Err(e)
              }
              _ => _rt::invalid_enum_discriminant(),
    ...
    pub mod graph {
            ...
            let result5 = match l2 {
              0 => {
                let e = {
                  ...
                  unsafe { super::super::super::wasi::nn::inference::GraphExecutionContext::from_handle(l3 as u32) }
                };
                Ok(e)
              }
              1 => {
                let e = {
                  ...
                  unsafe { super::super::super::wasi::nn::errors::Error::from_handle(l4 as u32) }
                };
                Err(e)
              }
              _ => _rt::invalid_enum_discriminant(),
      ...
      pub fn load(builder: &[GraphBuilder],encoding: GraphEncoding,target: ExecutionTarget,) -> Result<Graph,Error>{
        unsafe {
          ...
          unsafe { wit_import3(result1, len1, encoding.clone() as i32, target.clone() as i32, ptr2) };
          let l4 = i32::from(*ptr2.add(0).cast::<u8>());
          let result7 = match l4 {
            0 => {
              let e = {
            ...
            1 => {
              let e = {
                ...
                unsafe { super::super::super::wasi::nn::errors::Error::from_handle(l6 as u32) }
              };
              Err(e)
            }
            _ => _rt::invalid_enum_discriminant(),
          ...
          let result6 = match l3 {
            ...
            1 => {
              let e = {
                ...
                unsafe { super::super::super::wasi::nn::errors::Error::from_handle(l5 as u32) }
              };
              Err(e)
            }
            _ => _rt::invalid_enum_discriminant(),
  ...
  pub mod wasi {
    pub mod http {
      ...
      pub mod incoming_handler {
        ...
        _rt::run_ctors_once();T::handle(unsafe { super::super::super::super::wasi::http::types::IncomingRequest::from_handle(arg0 as u32) }, unsafe { super::super::super::super::wasi::http::types::ResponseOutparam::from_handle(arg1 as u32) });
      }
      pub trait Guest {
...
macro_rules! __export_nn_demo_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::wasi::http::incoming_handler::__export_wasi_http_incoming_handler_0_2_6_cabi!($ty with_types_in $($path_to_types_root)*::exports::wasi::http::incoming_handler);
  )
}
#[doc(inline)]
pub(crate) use __export_nn_demo_impl as export;

#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:enclave:nn-demo:nn-demo:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7584] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa2:\x01A\x02\x01A\x1e\
...
0.2.6\x05\x13\x04\0\x17enclave:nn-demo/nn-demo\x04\0\x0b\x0d\x01\0\x07nn-demo\x03\
