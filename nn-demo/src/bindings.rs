...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:nn-demo:nn-demo:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7580] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x9e:\x01A\x02\x01A\x1e\
...
0.2.6\x05\x13\x04\0\x13enclave:nn-demo/nn-demo\x04\0\x0b\x0d\x01\0\x07nn-demo\x03\0\0\
