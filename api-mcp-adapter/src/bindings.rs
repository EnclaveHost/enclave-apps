...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_api_mcp_adapter_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_api_mcp_adapter_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:api-mcp-adapter:api-mcp-adapter:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6650] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf42\x01A\x02\x01A\x19\
...
wasi:http/incoming-handler@0.2.6\x05\x11\x04\0'enclave:api-mcp-adapter/api-mcp-a\
dapter\x04\0\x0b\x15\x01\0\x0fapi-mcp-adapter\x03\0\0\0G\x09producers\x01\x0cpro\
