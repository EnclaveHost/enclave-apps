...
#[doc(inline)]
pub(crate) use __export_jot_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:jot:jot:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6614] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xdc2\x01A\x02\x01A\x19\
...
wasi:http/incoming-handler@0.2.6\x05\x11\x04\0\x0fenclave:jot/jot\x04\0\x0b\x09\x01\
\0\x03jot\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.\
