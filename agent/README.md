...
| `ENCLAVE_AGENT_NOTES_URL` | (unset) | a [jot](../jot) deployment (`https://<id8>.app.enclave.host`); when set, the five notebook tools (`notes_search/read/write/append/delete`) join the belt |
