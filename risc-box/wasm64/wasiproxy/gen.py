...
def iface_path(iid):
    ...
    return f"{snake(ns)}::{snake(name)}::{snake(i['name'])}"
...
def wrapper(t): return "Px" + camel(TYPES[t]["name"])
...
out.append('//! A wasm32 pass-through of every stable wasi 0.2.12 interface.')
