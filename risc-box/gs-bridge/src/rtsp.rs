...
use crate::session::{Session, StreamConfig, PORT_AUDIO, PORT_CONTROL, PORT_VIDEO, SS_ENC_AUDIO, SS_ENC_CONTROL_V2};
...
pub fn run(
    ...
    eprintln!("[rtsp] listening on :{}", crate::session::PORT_RTSP);
