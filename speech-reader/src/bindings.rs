...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_speech_reader_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_speech_reader_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:speech-reader:speech-reader:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7602] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xae:\x01A\x02\x01A\x1e\
...
0.2.6\x05\x13\x04\0#enclave:speech-reader/speech-reader\x04\0\x0b\x13\x01\0\x0ds\
peech-reader\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
