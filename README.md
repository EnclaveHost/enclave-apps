...
| [eyesoff-ai](eyesoff-ai/) | Private LLM chat on attested GPUs; prompts, replies, and history never leave the enclave and your browser. OpenAI-compatible API; ships no weights, serves whatever model volumes are attached. |
