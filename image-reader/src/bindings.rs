...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_image_reader_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_image_reader_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:image-reader:image-reader:encoded world"
)]
#[doc(hidden)]
...
0.2.6\x05\x13\x04\0!enclave:image-reader/image-reader\x04\0\x0b\x12\x01\0\x0cima\
ge-reader\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.\
