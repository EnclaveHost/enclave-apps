...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_ggml_probe_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_ggml_probe_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:enclave:ggml-probe:ggml-probe:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7593] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa8:\x01A\x02\x01A\x1e\
...
0.2.6\x05\x13\x04\0\x1denclave:ggml-probe/ggml-probe\x04\0\x0b\x10\x01\0\x0aggml\
-probe\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.227\
